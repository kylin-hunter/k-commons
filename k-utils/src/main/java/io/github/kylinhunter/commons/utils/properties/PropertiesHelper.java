...
import io.github.kylinhunter.commons.utils.bean.info.ExPropType;
...
public class PropertiesHelper {
  ...
  private static void processPropFileds(PropObjectPool objectPool, PropObject curPropObject) {
    ...
    for (PropFiled propFiled : curPropObject.getPropFileds()) {
      ...
      ExPropertyDescriptor propertyDescriptor =
          beanIntrospector.getExPropertyDescriptor(propFiled.getName());
      ...
      if (exPropType == ExPropType.PRIMITIVE_OR_WRAPPER) {
        ...
        Objects.requireNonNull(
            fullNamePropObject, "can't find full name Obj: " + propFiled.getFullName());
  ...
  private static void toProperties(
      Properties properties, String parent, Object obj, ExPropertyDescriptor exPd) {

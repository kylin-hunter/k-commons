...
public class BinLogClient {
  ...
  public BinLogClient(BinConfig config) {

    this.binConfig = config;
    ...
    savePointManager = binConfig.getSavePointManager();
  }
  ...
  public void start() {
    try {
      ...
      binaryLogClient.setBinlogFilename(binConfig.getBinlogFilename());
      binaryLogClient.setBinlogPosition(binConfig.getBinlogPosition());

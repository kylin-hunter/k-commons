...
public class WriteRowsEventDataProcessor extends BasicEventProcessor {
  ...
  public void process(BinLogEventListener binLogEventListener, EventData data, Context context) {
    if (data instanceof WriteRowsEventData) {
      ...
      insertDataRecord(eventData, context);
    }
  }
   ...
   */
  protected void insertDataRecord(WriteRowsEventData writeRowsEventData, Context context) {}

  @Override
  public EventType getEventType() {
    return EventType.EXT_WRITE_ROWS;
  }
}

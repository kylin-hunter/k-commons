...
class ScanRecordManagerTest {
  ...
  void test() throws SQLException {
    ...
    scanRecord.setId("1");
    when(scanRecordDAO.scanSameTime(any(), any())).thenReturn(ListUtils.newArrayList(scanRecord));
    List<ScanRecord> scanRecords = scanRecordManager.scanSameTime(null, null);
    ...
    List<ScanRecord> scanRecords2 = scanRecordManager.scanNextTime(null, null);

...
public class Methods {
  ...
  public static Set<Method> get(Class<?> clazz, Predicate<Method>... predicates) {
    Set<Method> result = CACHE_GET.computeIfAbsent(clazz, (c) ->
        Stream.of(c.getDeclaredMethods()).collect(Collectors.toCollection(LinkedHashSet::new))
    );
  ...
  public static Set<Method> getAll(Class<?> clazz, Predicate<Method>... predicates) {
    Set<Method> result = CACHE_GET_ALL.computeIfAbsent(clazz, (c) -> {

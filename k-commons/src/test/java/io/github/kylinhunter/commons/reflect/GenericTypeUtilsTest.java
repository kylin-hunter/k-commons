...
class GenericTypeUtilsTest {
    ...
    void test() throws NoSuchMethodException {
        ...
        Class<?> actualTypeClass = GenericTypeUtils.getSuperClassActualType(TestClassForGeneric.class, 0);
        ...
        ActualType[] interfacesActualTypes = GenericTypeUtils.getInterfaceActualTypes(TestClassForGeneric.class);

...
class InterfacesTest {
  ...
  void test() {
    ...
    Collection<Class<?>> result13 = Interfaces
        .get(ReflectBeanChild.class, e -> e.getSimpleName().equals("ReflectInterface3"));
    ...
    Collection<Class<?>> result23 = Interfaces
        .getAll(ReflectBeanChild.class, e -> !e.getSimpleName().equals("ReflectInterface1"),

...
class EnumUtilsTest {
    ...
    void testFromLabel() {
        ...
        TestEnumLabel[] testEnumTags = EnumUtils.fromLabel(TestEnumLabel.class, new String[] {"1", "2"});
    ...
    void testFromName() {
        ...
        TestEnumCode[] testEnumCodes = EnumUtils.fromName(TestEnumCode.class, new String[] {"TEST1", "TEST2"});
    ...
    void testThrows() {
        ...
        Assertions.assertThrows(KRuntimeException.class, () -> EnumUtils.fromCode(TestEnumCode.class, 7, true));
        ...
        Assertions.assertThrows(KRuntimeException.class, () -> EnumUtils.fromName(TestEnumCode.class, "test", true));

...
class SuperClassUtilsTest {
  ...
  void test() {
    ...
    Collection<Class<?>> result12 = SuperClassUtils.get(ReflectBeanChild.class);
    ...
    Collection<Class<?>> result22 = SuperClassUtils.getAll(ReflectBeanChild.class);

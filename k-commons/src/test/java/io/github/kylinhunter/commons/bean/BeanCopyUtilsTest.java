...
class BeanCopyUtilsTest {
  ...
  public void test() {
    ...
    Assertions.assertEquals(
        JsonUtils.writeToString(ListUtils.newArrayList(subBean)), bean2.getJsonList());
    Assertions.assertEquals(
        subBean.getText(),
    ...
    Assertions.assertEquals(
        subBean.getText(), JAXBHelper.unmarshal(SubBean.class, bean2.getXml()).getText());
    Assertions.assertEquals(
        subBean.getText(), YamlHelper.loadFromText(SubBean.class, bean2.getYaml()).getText());
    ...
    Assertions.assertEquals(
        bean1.getJsonList().get(0).getText(), bean1Reverse.getJsonList().get(0).getText());

    Assertions.assertEquals(bean1.getBytes().getText(), bean1Reverse.getBytes().getText());
    Assertions.assertEquals(
        bean1.getBytesList().get(0).getText(), bean1Reverse.getBytesList().get(0).getText());
